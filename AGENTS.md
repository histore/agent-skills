...
19. **CodeExplainer** (`Reasoning: High`): Analyzes and explains source code, control/data flows, and architectural decisions, formatting explanations and inserting didactic comments directly into code files in the user's operating system language.
